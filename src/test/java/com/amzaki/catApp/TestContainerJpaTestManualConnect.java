...
@Testcontainers
@DataJpaTest
class TestContainerJpaTestManualConnect {

    /** Single PostgreSQL container shared by every test in the class. */
    @Container
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16-alpine");
    // You had to manually provide connection properties:
    // With Spring Boot 3.1+, @ServiceConnection replaces this boilerplate.
